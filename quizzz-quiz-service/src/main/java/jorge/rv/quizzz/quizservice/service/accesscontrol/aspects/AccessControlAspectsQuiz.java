...
public class AccessControlAspectsQuiz {
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.QuizRepository.save(..)) && args(quiz,..)")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.QuizRepository.find(Long)) && args(id)")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.QuizRepository.findAll())")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.QuizRepository.delete(..)) && args(quiz)")
