...
public class AccessControlAspectsQuestion {
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.QuestionRepository.save(..)) && args(question)")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.QuestionRepository.find(Long)) && args(id)")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.QuestionRepository.findAll())")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.QuestionRepository.delete(..)) && args(question)")
