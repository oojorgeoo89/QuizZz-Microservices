...
public class AccessControlAspectsUser {
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.UserRepository.save(..)) && args(user)")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.UserRepository.find(Long)) && args(id)")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.UserRepository.findAll())")
	...
	@Around("execution(* jorge.rv.quizzz.quizservice.repository.UserRepository.delete(..)) && args(user)")
